...
CLOUDFLARE_API_TOKEN = "PEGA_AQUI_TU_API_TOKEN_DE_CLOUDFLARE"
CLOUDFLARE_ACCOUNT_ID = "PEGA_AQUI_TU_ACCOUNT_ID"
KV_NAMESPACE_ID = "PEGA_AQUI_TU_KV_NAMESPACE_ID"
...
def verificar_acceso(user_id):
    ...
    try:
        url = f"https://api.cloudflare.com/client/v4/accounts/{CLOUDFLARE_ACCOUNT_ID}/storage/kv/namespaces/{KV_NAMESPACE_ID}/values/user:{user_id}"
